...
namespace WindowsFormsApplication5 {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string Name, string address, string Notes, string phone, string email, bool isActive, string Image) {
...
namespace WindowsFormsApplication5.CustomerDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([Name], [address], [Notes], [phone], [email], [isActive], [Image]) VALUES (@Name, @address, @Notes, @phone, @email, @isActive, @Image);
SELECT id, Name, address, Notes, phone, email, isActive, Image FROM Customer WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Name] = @Name, [address] = @address, [Notes] = @Notes, [phone] = @phone, [email] = @email, [isActive] = @isActive, [Image] = @Image WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_isActive = 1 AND [isActive] IS NULL) OR ([isActive] = @Original_isActive)));
SELECT id, Name, address, Notes, phone, email, isActive, Image FROM Customer WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Name, address, Notes, phone, email, isActive, Image FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_id, string Original_Name, string Original_phone, string Original_email, global::System.Nullable<bool> Original_isActive) {
        ...
        public virtual int Insert(string Name, string address, string Notes, string phone, string email, global::System.Nullable<bool> isActive, string Image) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string address, string Notes, string phone, string email, global::System.Nullable<bool> isActive, string Image, int Original_id, string Original_Name, string Original_phone, string Original_email, global::System.Nullable<bool> Original_isActive, int id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string address, string Notes, string phone, string email, global::System.Nullable<bool> isActive, string Image, int Original_id, string Original_Name, string Original_phone, string Original_email, global::System.Nullable<bool> Original_isActive) {
            return this.Update(Name, address, Notes, phone, email, isActive, Image, Original_id, Original_Name, Original_phone, Original_email, Original_isActive, Original_id);
        }
    }
